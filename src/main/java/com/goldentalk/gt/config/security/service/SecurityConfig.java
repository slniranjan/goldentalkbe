    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE,  "/api/v1/students/**", "/api/v1/sections/**", "/api/v1/courses/**",  "/api/v1/teachers/**")
                            .hasRole(UserRole.ADMIN.name())
                        .requestMatchers(HttpMethod.PUT,  "/api/v1/students/**", "/api/v1/sections/**", "/api/v1/courses/**",  "/api/v1/teachers/**")
                            .hasRole(UserRole.ADMIN.name())
                        .requestMatchers(HttpMethod.PATCH,  "/api/v1/students/**", "/api/v1/sections/**", "/api/v1/courses/**",  "/api/v1/teachers/**")
                            .hasRole(UserRole.ADMIN.name())
                        .requestMatchers(  "/auth/addNewUser")
                            .hasRole(UserRole.ADMIN.name())
                        .requestMatchers("/api/v1/students/**", "/api/v1/sections/**", "/api/v1/courses/**", "/api/v1/teachers/**")
